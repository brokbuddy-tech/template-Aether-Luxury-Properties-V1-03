    ...
    <div className="container py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2">
          ...
          <div className="mb-8">
            <p className="text-3xl md:text-4xl font-extrabold text-primary">AED {property.price.toLocaleString()}</p>
          ...
          {property.dldPermitNo && qrCodeImage && (
            <div className="py-8">
                <div className="p-6 rounded-lg bg-muted/50 flex flex-col md:flex-row items-center text-center md:text-left gap-6">
                    <Image
