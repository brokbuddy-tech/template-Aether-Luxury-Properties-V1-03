...
export const properties: Property[] = [
  {
    ...
    price: 3500000,
    address: 'Villa 123, Frond K, Palm Jumeirah, Dubai',
    bedrooms: 5,
    bathrooms: 6,
    area: 5200,
    image: 'property-1-ext',
    images: ['property-1-ext', 'property-1-int', 'property-2-int'],
    description: 'Nestled in the prestigious Palm Jumeirah, this modern villa offers unparalleled luxury and breathtaking sea views. Featuring an open-plan living space, a gourmet kitchen, and an infinity pool, this property is an oasis of tranquility and sophistication.',
    keyFeatures: ['Infinity Pool', 'Sea Views', 'Gourmet Kitchen', 'Home Theater', 'Private Beach Access'],
    agent: {
      name: 'Isabella Rossi',
      image: 'agent-1',
    },
  ...
  },
  {
    ...
    price: 5200000,
    address: 'Cayan Tower, Dubai Marina, Dubai',
    bedrooms: 3,
    bathrooms: 4,
    area: 3800,
    image: 'property-2-ext',
    images: ['property-2-ext', 'property-2-int', 'property-3-int'],
    description: 'Experience the height of urban living in this exquisite apartment in Dubai Marina. With panoramic views of the marina, floor-to-ceiling windows, and bespoke finishes, this residence is the epitome of elegance. Building amenities include a rooftop pool, fitness center, and 24/7 concierge.',
  ...
  },
  {
    id: '4',
    type: 'RENT',
    title: 'Chic Apartment in Dubai Marina',
    price: 180000,
    ...
    description: 'Located in the vibrant Dubai Marina, this stylish apartment features high ceilings, stunning views and an open-concept layout. Perfect for professionals seeking a dynamic urban lifestyle.',
    keyFeatures: ['High Ceilings', 'Marina Views', 'Walkable to JBR', 'Community Gym', 'Secure Parking'],
    agent: {
      name: 'James Carter',
      image: 'agent-2',
    },
...
export const commercialProperties: CommercialProperty[] = [
  ...
  },
  {
    ...
    propertyType: 'Retail',
    title: 'Prime Retail Unit in Business Bay',
    price: 850000,
    address: 'Opus Tower, Business Bay, Dubai',
    area: 2500,
    image: 'commercial-2',
    images: ['commercial-2', 'commercial-retail-int-1', 'hero-dubai'],
    description: 'Exceptional retail opportunity with high footfall in the heart of Business Bay. Features a wide glass frontage and modern interiors, ideal for a luxury brand.',
    agent: {
      name: 'Isabella Rossi',
      image: 'agent-1',
    },
  ...
  },
  {
    ...
    transactionType: 'RENT',
    propertyType: 'Office',
    title: 'Modern Co-working Space in Business Bay',
    price: 25000,
    address: 'Bay Square, Business Bay, Dubai',
    area: 1500,
    image: 'commercial-office-int-1',
    images: ['commercial-office-int-1', 'commercial-1', 'hero-dubai'],
    description: 'A vibrant and fully-serviced office space in Business Bay with flexible terms. Includes access to meeting rooms, high-speed internet, and a professional community. Ideal for startups and freelancers.',
    agent: {
      name: 'Isabella Rossi',
      image: 'agent-1',
    },
...
export const offPlanProjects: OffPlanProject[] = [
  ...
  {
    id: 'op-3',
    projectName: 'Serene Gardens',
    developer: 'GreenScape Properties',
    handover: 'Q4 2027',
    image: 'property-1-int',
    images: ['property-1-int', 'property-3-int'],
    description: 'An oasis in the city, Serene Gardens offers a unique blend of nature and luxury. Featuring apartments with private gardens and extensive green spaces throughout the community.',
    paymentPlan: [
      { milestone: 'Booking Amount', percentage: 10, amount: 120000 },
      { milestone: 'On 30% Construction', percentage: 15, amount: 180000 },
      { milestone: 'On 60% Construction', percentage: 15, amount: 180000 },
      { milestone: 'On Handover', percentage: 60, amount: 720000 },
    ],
  },
];
